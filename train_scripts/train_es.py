...
def train_svm_6():
    model_name = "questions6_svm_ES_googtx_0.7.0a1"
    dataset = "raw_questions_ES_googtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("es")
    _train_6(model_name, dataset, clf)


def train_svm_52():
    model_name = "questions52_svm_ES_googtx_0.7.0a1"
    dataset = "raw_questions_ES_googtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("es")
    _train_52(model_name, dataset, clf)


def train_apertium_svm_6():
    model_name = "questions6_svm_ES_apertium_0.7.0a1"
    dataset = "raw_questions_ES_apertiumtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("es")
    _train_6(model_name, dataset, clf)


def train_apertium_svm_52():
    model_name = "questions52_svm_ES_apertium_0.7.0a1"
    dataset = "raw_questions_ES_apertiumtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("es")
    _train_52(model_name, dataset, clf)
...
def train_nb_sent2():
    model_name = "questions2_nb_ES_apertium_0.7.0a1"
    dataset = "simple_tags_ES_apertiumtx0.7.0a1.txt"
