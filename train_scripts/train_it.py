...
def train_svm_6():
    model_name = "questions6_svm_IT_googtx_0.7.0a1"
    dataset = "raw_questions_IT_googtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("it")
    _train_6(model_name, dataset, clf)


def train_svm_52():
    model_name = "questions52_svm_IT_googtx_0.7.0a1"
    dataset = "raw_questions_IT_googtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("it")
