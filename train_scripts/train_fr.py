...
from little_questions.classifiers import LinearSVCTextClassifier
...
def train_svm_6():
    model_name = "questions6_svm_FR_googtx_0.7.0a1"
    dataset = "raw_questions_FR_googtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("fr")
    _train_6(model_name, dataset, clf)


def train_svm_52():
    model_name = "questions52_svm_FR_googtx_0.7.0a1"
    dataset = "raw_questions_FR_googtx0.7.0a1.txt"
    clf = LinearSVCTextClassifier("fr")
