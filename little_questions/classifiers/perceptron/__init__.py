...
class SimplePerceptronQuestionClassifier(PerceptronQuestionClassifier, SimpleQuestionClassifier):
    def __init__(self, name="perceptron_main"):
        super().__init__(name)
...
if __name__ == '__main__':
    train = True
    search = False
    clf = SimplePerceptronQuestionClassifier()
    if search:
        t, tt = clf.load_data()
